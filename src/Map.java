...
//        theFirstRoom = room1;
        ...
        //Weapons:
        room1.addMeleeWeapon("sword", " it's the queen of hearts sword, it is used only to cap of heads of those who does not do as the queen commands.", -100);
        room1.addRangedWeapon("bow", " it's a bow, with it is 5 arrows", -30, 5);
